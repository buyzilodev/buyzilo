...
export default function VendorQuotesPage() {
  ...
  return (
    <VendorLayout title="Quote Requests" subtitle="Handle RFQ-style product inquiries, pricing responses, and follow-up from one queue">
      ...
      <section className="mt-5 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
        <h2 className="text-sm font-bold uppercase tracking-[0.08em] text-slate-800">Quote Queue</h2>
        {loading ? (
          ...
          <div className="py-12 text-center">
            ...
            <p className="mt-1 text-sm text-slate-500">Quote-only listings will start appearing here once buyers submit requirements.</p>
          </div>
        ) : (
              ...
              <article key={request.id} className="rounded-2xl border border-slate-200 p-4">
                ...
                <div className="mt-4 grid gap-3 md:grid-cols-[1fr_180px]">
                  <RichTextEditor
                    ...
                    output="text"
                    placeholder="Respond with pricing terms, lead time, or qualification questions."
